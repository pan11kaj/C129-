...
import time
import csv
START_URL = "https://exoplanetarchive.ipac.caltech.edu/cgi-bin/TblView/nph-tblView?app=ExoTbls&config=planets"
browser = webdriver.Chrome(r"C:\Users\Pankaj\Downloads\error-scraping-main\scraping data\chromedriver.exe")
